...
original_title = '<p style="font-family:Franklin Gothic Medium;text-align:center;color:Yellow; font-size: 70px;">Chest X-ray Captioning</p>'
st.markdown(original_title, unsafe_allow_html=True)
Author_Name = '<right><p style="font-family:Franklin Gothic Medium;text-align:left;color:Red;font-weight: bold; font-size: 20px;">by Santhosh Kurnapally</p></right>'
